								...
								<div class="row">
									...
									<div class="col-md-12">
										<div class="box border dark gray">
											<div class="box-title">
												<p class="title-font">Submit Reports</p>
											...
											<span id="error" class='error'></span>
											 ...
											 <input type="hidden" name="workshop_id" value="<?php echo  $editWorkshop['workshop_id'];  ?> " />
												  ...
												  <div class="form-group">
													...
													<div class="col-sm-6">
													  <input type="text" name = "participate_attend" id = "participate_attend" value="<?php echo $report_data[0]['participate_attend'];?>" class="required form-control no-radius required-width" >													
													...
													<div class="col-sm-6">
													  <input type="text" required name = "participate_experiment" id = "participate_experiment" value="<?php echo $report_data[0]['participate_experiment'];?>" class=" form-control no-radius required-width" >
													  <?php echo "<span style='color:red'>".form_error('participate_experiment')."</span>"; ?>
													</div>
												  </div>
												 	
												<div class="newaa label-names">Upload documents</div>
												  <div class="form-group">
													<label class="col-sm-3 label-names">Attendance sheet<span style="color:red">*</span></label>
													<div class="col-sm-6">
													 <?php echo $report_data[0]['upload_attend_sheet'];?>
													  <input type="file" value="" name = "upload_attend_sheet" id = "upload_attend_sheet" class="required form-control no-radius" >
													...
													<div class="col-sm-6">
													<?php echo $report_data[0]['college_report'];?>
													  <input type="file" value="<?php echo $report_data[0]['college_report'];?>"  name = "college_report" id = "college_report" class="required form-control no-radius" >
													...
													<div class="col-sm-6">
													<?php echo $report_data[0]['workshop_photos'];?>
													  <input type="file" value="" class="form-control no-radius" name="workshop_photos">
												  ...
												  <div class="form-group">
													...
													<div class="col-sm-6">
													  <textarea class="form-control no-radius" rows="3" name="comments_positive"><?php echo $report_data[0]['comments_positive'];?></textarea>
												   ...
												   <div class="form-group">
													...
													<div class="col-sm-6">
													  <textarea  class="form-control no-radius" rows="3" name="comments_negative"><?php echo $report_data[0]['comments_negative'];?></textarea>
